...
## PR05 fresh decision — 2026-09-13T15:00:21.380965+00:00

Canonical machine-readable decision: `ops/release/hosting-decision.json`. Public WordPress/Elementor nginx response at 89.184.75.186; Mirohost delegation observed again. TLS SAN apex/www, expiry 2026-10-13. Account access is unproven. DECISION_PENDING_ACCESS; no recommended executable candidate. All 13 capability dimensions assessed for current host, Cloudflare Pages + Worker/Functions and GitHub Pages alone. The latter is insufficient. All 49 HOLD rows remain unresolved, with an explicit unexecuted legacy-origin/static preservation prerequisite. Existing KEEP /sitemap_index.xml remains 404. See release RUNBOOK for exact preflight and recovery requirements.
