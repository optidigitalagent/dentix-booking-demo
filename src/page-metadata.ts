...
import { implantProstheticsPages } from "./data/implant-prosthetics-pages.ts";
...
export const routeMetadata = {
  ...
  implantation: implantProstheticsPages.implantation,
  prosthetics: implantProstheticsPages.prosthetics,
};
